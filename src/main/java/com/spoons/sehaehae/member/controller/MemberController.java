...
import com.spoons.sehaehae.member.dto.ProfileAttachmentDTO;
...
public class MemberController {
    ...
    public MemberController(MemberService memberService, AuthenticationService authenticationService, MessageSourceAccessor messageSourceAccessor, PasswordEncoder passwordEncoder, EmailUtil emailUtil) {
...
//    }
     ...
     * PageContext
     *
     * 양슬기님 -> 크롬 -> 웹사이트를 접속함. => 1개의세션이 만들어져요. (쿠키)
     *        -> 브라우저가 바뀌거나, 시크릿모드로 했읋떈 또다른 세션 생성됨.
     *
     *
     * */
